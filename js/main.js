            ...
            setTimeout(function(){$('.more_info_anim10').addClass('animated fadeInRight')},400);
				...
				$('#feature5').waypoint(function() {
		            ...
		            setTimeout(function(){$('.more_info_anim10').addClass('animated fadeInRight')},400);
						...
						$('#feature6').waypoint(function() {
				            setTimeout(function(){$('.more_info_anim4').addClass('animated fadeInUp')},0);
				            setTimeout(function(){$('.more_info_anim5').addClass('animated fadeInLeft')},200);
				            setTimeout(function(){$('.more_info_anim6').addClass('animated fadeInLeft')},400);
				            setTimeout(function(){$('.more_info_anim7').addClass('animated fadeInRight')},200);
				            setTimeout(function(){$('.more_info_anim8').addClass('animated fadeInRight')},400);
				        }, { offset: '50%' });
